...
The difference in control input can be seen in the following \figref{arg1}

\begin{figure}[htb]
	\centering
	\fontsize{8}{0}\selectfont
	\def\svgwidth{0.49\textwidth}
	\input{images/MPC_Horizon_60.pdf_tex}
	\caption{}
	\label{}
\end{figure}
...
\begin{figure}[htb]
	...
	\fontsize{8}{0}\selectfont
	\def\svgwidth{0.49\textwidth}
	\input{images/mpc_comparison_horizon.pdf_tex}
	\caption{}
	\label{}
\end{figure}
