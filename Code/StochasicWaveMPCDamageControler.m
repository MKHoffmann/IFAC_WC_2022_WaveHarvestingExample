%% In addition to the MPC Algorithm this script has an additional heurisitc
%% damage controler. The Goal is to arrive at a specific damage state at a
%% specific time. 


%  Define MPC and damage parameters. These can and should be chosen by the user.


% Suggested
% values
DamageTarget = 0.35;           % [0.2-0.6] Damage accumulates liniarly. So if you want to simulate
...
StartingWeight = 0.5       % [0-1]    The weight will be adjusted over the MPC horizon. Still, a starting weight 
%need to be provided
